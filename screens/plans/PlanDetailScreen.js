...
import { RoundedButton, DefaultPanel, CalculatorInput, AvenirText, Icon, Datepicker, AccountPicker, CategoryPicker, ContactPicker, CustomSwitch, DateTimepicker} from '../../components';
      ...
      return (
        <KeyboardAvoidingView style={{flex: 1, backgroundColor: Colors.backgroundColor}} behavior="padding" enabled>
          <ScrollView contentContainerStyle={styles.container}>
            ...
            <DefaultPanel containerStyle={styles.moreInfoPanel} notitle>
...
export default connect(mapStateToProps, { ...transactionsOperations, ...accountsOperations, ...categoriesOperations })(PlanDetailScreen);
